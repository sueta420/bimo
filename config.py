...
def build_config() -> dict[str, Any]:
    ...
    return {
        ...
        "bybit_http_timeout_sec": env_int("BYBIT_HTTP_TIMEOUT_SEC", 20),
        ...
        "target_risk_usd": env_float("TARGET_RISK_USD", 0.0),
        "min_risk_utilization": env_float("MIN_RISK_UTILIZATION", 0.0),
        "target_leverage": env_int("TARGET_LEVERAGE", 1),
        "dynamic_leverage_enabled": env_bool("DYNAMIC_LEVERAGE_ENABLED", False),
        "fakeout_target_leverage": env_int("FAKEOUT_TARGET_LEVERAGE", 3),
        "breakout_target_leverage": env_int("BREAKOUT_TARGET_LEVERAGE", 5),
        "reversal_target_leverage": env_int("REVERSAL_TARGET_LEVERAGE", 2),
        "dynamic_leverage_high_score": env_int("DYNAMIC_LEVERAGE_HIGH_SCORE", 80),
        "dynamic_leverage_low_score": env_int("DYNAMIC_LEVERAGE_LOW_SCORE", 72),
        "dynamic_leverage_high_score_bonus": env_int("DYNAMIC_LEVERAGE_HIGH_SCORE_BONUS", 1),
        "dynamic_leverage_low_score_cut": env_int("DYNAMIC_LEVERAGE_LOW_SCORE_CUT", 1),
        "dynamic_leverage_high_atr_ratio": env_float("DYNAMIC_LEVERAGE_HIGH_ATR_RATIO", 0.012),
        "dynamic_leverage_high_atr_cut": env_int("DYNAMIC_LEVERAGE_HIGH_ATR_CUT", 1),
        ...
        "max_side_risk_usd": env_float("MAX_SIDE_RISK_USD", 0.0),
        ...
        "fakeout_min_vol_ratio": env_float("FAKEOUT_MIN_VOL_RATIO", 70.0),
        ...
        "bybit_read_retries": env_int("BYBIT_READ_RETRIES", 2),
        "bybit_read_retry_delay_ms": env_int("BYBIT_READ_RETRY_DELAY_MS", 800),
